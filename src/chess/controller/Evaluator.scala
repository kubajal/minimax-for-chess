...
import chess.model.{Figure, FigureType}

/**
  * Represents a function that is used by [[chess.controller.Algorithm]] to evaluate the state of the board from the maximizing players perspective.
  * Gives clue how good the situtation on the board is for the maximizing player.
  *
  * @param maximizing The color of the player whose score is to be maximized.
  */
class Evaluator(val maximizing : PlayerColor) {
  ...
  val rookTable : Array[Array[Int]] = Array(
    ...
    Array(9,12,12,12,12,12,12, 9),
    Array(9,12,12,15,15,12,12, 9),
    Array(9,12,12,15,15,12,12, 9),
    Array(9,12,12,12,12,12,12, 9),
    Array(9,10,10,10,10,10,10, 9),
    Array(9, 9, 9, 9, 9, 9, 9, 9)
